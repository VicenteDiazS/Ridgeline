...
- Review Garage restore with a real user backup file before adding overwrite/merge conflict choices, plus real-device review of the Diagnostics and Garage mobile density before adding more workflow surfaces. The next small verification slice should turn the Playwright restore-validation fallback into reusable audit coverage.
