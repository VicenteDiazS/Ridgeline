...
- Garage maintenance staging Counter Mode completion includes Draft Staged Parts in the sticky completion panel, so the completed parts-counter list can be moved into the existing Final Part Numbers draft without scrolling through the full staging panel.
