...
- Garage maintenance staging Counter Mode is sticky at iPhone width and includes Copy Next Item, so the current parts-counter line can be copied alone while Mark Next Staged, Undo Last, Copy Buy List, and Exit remain thumb-reachable.
