...
- Garage maintenance staging Counter Mode is sticky at iPhone width and includes Copy Next Item plus Share Next Item, so the current parts-counter line can be copied or sent through Web Share by itself while Mark Next Staged, Undo Last, Copy Buy List, and Exit remain thumb-reachable.
