...
- Final-part-number handoffs should work after the parts-counter run is complete: keep a staged-list draft path available when all need-to-buy lines have been marked staged, and still require user-entered confirmation before saving to Truck Profile.
