...
- Maintenance now includes `maintenance.html#service-prep`, a mobile-friendly Service Prep Planner with oil, wheel/tire, battery, and filter checklist cards, copy/reset controls, Garage routing, search coverage, and browser-smoke assertions without adding new vehicle facts.
...
- Next safe slice: real-device review of the Maintenance planner Save Note wording and saved Garage Notes output before adding more planner-to-Garage handoffs such as Service Prep save-to-note.
