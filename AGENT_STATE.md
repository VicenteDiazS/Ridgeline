...
- Next safe slice: review Maintenance page iPhone density now that both Service Prep and Minder planners are present, then decide whether to add a Garage-note handoff for built planner text or keep the feature copy-only.
