...
- Diagnostics local resume now has a dynamic Open Latest action that targets the saved handoff builder, first-check tracker, or call summary based on the freshest diagnostic context on this iPhone.
