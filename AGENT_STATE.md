...
- Next safe slice: add a Maintenance Minder Pocket Planner near `maintenance.html#minder` that builds a compact checklist only from the already-sourced A/B and sub-item 1-6 tables, with no mileage prediction and no brake-fluid sub-code.
