export const searchIndex = [
  ...
  },
  {
    ...
    category: "Garage",
    excerpt: "Garage preview, parts-counter staging checklist, local one-off store items with quick-add supply chips and quick kits, plus copy, share, save, and Truck Profile final-part-number handoff actions for Service Prep and Maintenance Minder planner notes saved from the Maintenance page.",
    keywords: ["saved maintenance notes", "maintenance notes", "garage maintenance notes", "saved prep notes", "saved minder notes", "confirm maintenance note", "service prep saved", "minder saved", "copy maintenance note", "copy saved prep note", "parts staging list", "supplies staging list", "parts counter list", "maintenance staging", "one off store item", "one-off store item", "add store item", "quick add store item", "quick kit", "quick kits", "oil run", "filter run", "electrical check", "cleanup kit", "extra parts item", "shop towels", "funnel", "gloves", "brake cleaner", "trim clips", "drain pan", "need to buy", "buy list", "copy buy list", "copy job buy list", "copy saved note buy list", "share buy list", "share job buy list", "save buy note", "save this buy note", "save job buy note", "save need to buy", "save shopping list", "save run note", "maintenance run note", "parts run note", "need to buy list", "already staged", "staged parts", "final part numbers", "save part numbers", "save parts to profile", "truck profile parts", "confirmed parts"]
  },
  {
