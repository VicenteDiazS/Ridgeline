export const searchIndex = [
  ...
  },
  {
    ...
    category: "Navigation",
    excerpt: "Anton page strip and iPhone review queue showing the changed page, home monitor check, action-needed note, run trace, and next scheduled check from the latest public run status.",
    keywords: ["anton owner check", "anton review queue", "anton iphone review", "anton next check", "anton changed page", "what anton changed", "agent owner check", "agent next check", "anton controls", "anton page"]
  },
  {
  ...
  },
  {
    ...
    category: "Navigation",
    excerpt: "Global Search strip that appears when this iPhone has saved roadside handoffs, service receipts, or Garage notes, letting the owner resume recent work from any page.",
    keywords: ["recent work search strip", "recent owner work", "continue recent work", "last roadside note", "latest service receipt", "garage notes shortcut", "recent handoff", "iphone recent work"]
  },
  {
  ...
  },
  {
    ...
    category: "Personal",
    excerpt: "iPhone checklist and copy/share Garage snapshot for deciding what Garage record to fill in next: truck profile, service closeout, warning-light note, photos, area notes, and backup.",
    keywords: [
      "garage fill in",
