export const searchIndex = [
  ...
  },
  {
    ...
    category: "Garage",
    excerpt: "Garage preview, parts-counter staging checklist, local one-off store items, and copy, share, or save handoff actions for Service Prep and Maintenance Minder planner notes saved from the Maintenance page.",
    keywords: ["saved maintenance notes", "maintenance notes", "garage maintenance notes", "saved prep notes", "saved minder notes", "confirm maintenance note", "service prep saved", "minder saved", "copy maintenance note", "copy saved prep note", "parts staging list", "supplies staging list", "parts counter list", "maintenance staging", "one off store item", "one-off store item", "add store item", "extra parts item", "need to buy", "buy list", "copy buy list", "copy job buy list", "copy saved note buy list", "share buy list", "share job buy list", "save buy note", "save this buy note", "save job buy note", "save need to buy", "save shopping list", "save run note", "maintenance run note", "parts run note", "need to buy list", "already staged", "staged parts"]
  },
  {
